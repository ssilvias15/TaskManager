...
<body>
					...
					<li><a href="#"><i class="fa fa-sitemap fa-fw"></i> Tasks<span
						...
						<ul class="nav nav-second-level">
							...
							<li><a href="<%=request.getContextPath()%>/recenttasks.htm">Recent
									Tasks</a></li>
							<li><a href="<%=request.getContextPath()%>/create.htm">Add New</a></li>
	...
	<!-- jQuery -->
	<script
		src="<%=request.getContextPath()%>/resources/theme/bower_components/jquery/dist/jquery.min.js"></script>

	<!-- Bootstrap Core JavaScript -->
	<script
		src="<%=request.getContextPath()%>/resources/theme/bower_components/bootstrap/dist/js/bootstrap.min.js"></script>

	<!-- Metis Menu Plugin JavaScript -->
	<script
		src="<%=request.getContextPath()%>/resources/theme/bower_components/metisMenu/dist/metisMenu.min.js"></script>

	<!-- Custom Theme JavaScript -->
	<script
		src="<%=request.getContextPath()%>/resources/theme/dist/js/sb-admin-2.js"></script>
